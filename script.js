...
var playButtons = document.querySelector("div.buttonBox");
...
function winCheck() {
    ...
    newGame.innerHTML = '<button class="button" onClick="window.location.href=window.location.href">New Game</button>'; instructions.appendChild(newGame);}
}
